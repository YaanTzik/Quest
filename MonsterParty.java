...
public class MonsterParty extends Party<Monster> {
    ...
    public void createParty() {
        ...
        Monster D1 = new Dragon("Desghidorrah", 3, 150, 200, 35);
        // System.out.println("First Dragon Created");
        Monster D2 = new Dragon("Chrysophylax", 2, 100, 250, 20);
        Monster D3 = new Dragon("Bunsen Burner", 4, 200, 250, 45);
        Monster D4 = new Dragon("The Scaleless", 7, 350, 200, 75);
        Monster D5 = new Dragon("Kas-Ethelinh", 5, 300, 250, 60);
        Monster D6 = new Dragon("Alexstraszan", 10, 500, 4500, 55);
        Monster D7 = new Dragon("D-Maleficent", 9, 450, 400, 85);

...
public class MonsterParty extends Party<Monster> {
    ...
    public void createParty() {
        ...
        Monster D8 = new Dragon("The Weather Be", 8, 200, 200, 80);
        Monster D9 = new Dragon("WINGED DRAGON OF RA", 15, 1000, 2000, 50);
        Monster D10 = new Dragon("Dragon Hatchling", 1, 50, 50, 20);
        // System.out.println("All Dragons Created");

        Monster Ex1 = new ExoSkeleton("Cyrollalee", 7, 100, 150, 75);
        Monster Ex2 = new ExoSkeleton("Brandobaris", 3, 85, 100, 30);
        Monster Ex3 = new ExoSkeleton("Skeleton", 1, 75, 50, 15);
        Monster Ex4 = new ExoSkeleton("Wicked Witch", 2, 60, 80, 25);
        Monster Ex5 = new ExoSkeleton("Aasterinian", 4, 100, 125, 45);
        Monster Ex6 = new ExoSkeleton("Chronepsish", 6, 150, 180, 60);
        Monster Ex7 = new ExoSkeleton("Merrshaullk", 10, 200, 180, 55);
        Monster Ex8 = new ExoSkeleton("St-Yeenoghu", 9, 150, 220, 90);
        Monster Ex9 = new ExoSkeleton("OBELISK THE TORMENTOR", 15, 1500, 800, 50);

        Monster S1 = new Spirit("Andrealphus", 2, 150, 100, 40);
        Monster S2 = new Spirit("Aim-Haborum", 1, 100, 60, 35);
        Monster S3 = new Spirit("Andromalius", 3, 100, 100, 25);
        Monster S4 = new Spirit("Fallen Angel", 5, 150, 120, 50);
        Monster S5 = new Spirit("Ereshkigall", 6, 225, 100, 35);
        Monster S6 = new Spirit("Jormunngad", 8, 150, 200, 20);
        Monster S7 = new Spirit("Rakkshasass", 9, 150, 150, 35);
        Monster S8 = new Spirit("Tatlcuhtli", 10, 250, 200, 50);
        Monster S9 = new Spirit("EXODIA", 20, 2000, 1500, 50);
